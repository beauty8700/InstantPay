...
const JWT_SECRET = process.env.JWT_SECRET || "instapay_dev_secret";
if (!process.env.JWT_SECRET) {
  console.warn("⚠️  JWT_SECRET is not set. Using fallback development secret. Set JWT_SECRET in .env for production.");
}
